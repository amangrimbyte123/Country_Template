          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-block mb-4">
              {logo ? (
                ...
                <div
                  className="h-12 px-5 flex items-center justify-center text-white font-bold text-lg rounded-lg"
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 rounded-full bg-gray-800 hover:bg-gray-700 flex items-center justify-center text-gray-400 hover:text-white transition-all duration-200 hover:scale-110"
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <a href={`mailto:${supportEmail}`} className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">
                  {supportEmail}
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href={`tel:${contactPhone}`} className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">
                  {contactPhone}
                </a>
              </li>
              <li className="flex items-start gap-3">
