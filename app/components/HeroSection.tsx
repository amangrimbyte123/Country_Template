...
export default function HeroSection({ basicInfo }: HeroSectionProps) {
  ...
  return (
    <section 
      className="relative min-h-[500px] md:min-h-[600px] flex items-center overflow-hidden pt-[72px] pb-16 md:pb-20"
      style={{ 
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            ...
            <div className="text-center md:text-left animate-fade-in">
              {/* Premium Badge */}
              <div className="inline-flex items-center gap-2 mb-6 px-5 py-2.5 rounded-full backdrop-blur-md border border-white/20 shadow-lg" style={{ backgroundColor: `${secondaryColor}40` }}>
              ...
              <h1 className="mb-6 leading-[1.1]">
                <span 
                  className="block text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mb-3 text-white drop-shadow-2xl"
                  style={{
                ...
                <span 
                  className="block text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-white via-white to-yellow-200 bg-clip-text text-transparent"
                  style={{
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-4">
                    <div className="relative group">
                      ...
                      <input
                        type="text"
                        placeholder={`Search for ${defaultService}...`}
                        className="w-full pl-12 pr-4 py-4 rounded-xl text-black placeholder-gray-500 bg-gray-50/80 border-2 border-gray-200 focus:outline-none focus:ring-2 focus:border-transparent transition-all text-base font-medium"
                        style={{ 
                    ...
                    <div className="relative group">
                      ...
                      <select 
                        className="w-full pl-12 pr-12 py-4 rounded-xl text-black bg-gray-50/80 border-2 border-gray-200 focus:outline-none focus:ring-2 focus:border-transparent appearance-none transition-all text-base font-medium"
                        style={{ 
                          '--tw-ring-color': secondaryColor,
                        } as React.CSSProperties & { '--tw-ring-color'?: string }}
                      >
                    ...
                    <button 
                      className="w-full py-4 rounded-xl font-bold text-white shadow-xl hover:shadow-2xl transform hover:scale-[1.02] transition-all duration-300 flex items-center justify-center gap-3 text-base relative overflow-hidden group"
                      style={{ 
